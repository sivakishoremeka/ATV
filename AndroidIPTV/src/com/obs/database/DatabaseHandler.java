...
public class DatabaseHandler extends SQLiteOpenHelper {
	...
	private static final String TABLE_PROGRAM_CHANNELS = "channels";
	...
	public void onCreate(SQLiteDatabase db) {
		String CREATE_CHANNELS_TABLE = "CREATE TABLE " + TABLE_PROGRAM_CHANNELS
				+ "(" + KEY_ID + " INTEGER PRIMARY KEY AUTOINCREMENT,"
				+ KEY_PROG_NAME + " TEXT," + KEY_TIME + " INTEGER,"
				 + KEY_CHANNEL_ID + " INTEGER,"+ KEY_CHANNEL_NAME + " TEXT," 
				+ KEY_URL + " TEXT," + KEY_IS_FAVOURITE + " NUMERIC"+ ")";
		db.execSQL(CREATE_CHANNELS_TABLE);
	}

	@Override
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		db.execSQL("DROP TABLE IF EXISTS " + TABLE_PROGRAM_CHANNELS);
		onCreate(db);
	}
	...
	public void addReminder(Reminder reminder) {
		...
		db.insert(TABLE_PROGRAM_CHANNELS, null, values);
		db.close();
	}
	...
	public List<Reminder> getAllReminder() {
		...
		// Select All Query
		String selectQuery = "SELECT  * FROM " + TABLE_PROGRAM_CHANNELS;
	...
	public void deleteOldReminders() {
		...
		db.delete(TABLE_PROGRAM_CHANNELS, KEY_TIME + " < " + currentMillies,
				null);
		db.close();
	}
	...
	public void deleteAllReminders() {
		SQLiteDatabase db = this.getWritableDatabase();
		db.execSQL("delete from " + TABLE_PROGRAM_CHANNELS);
		db.close();
	}
}
